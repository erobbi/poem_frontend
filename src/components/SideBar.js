        ...
        <div id="sidebar" className="ui left fixed vertical menu">
          <div className="item">
            <div className="ui transparent icon input">
              <input type="text" placeholder="Search Poems..." onChange={handleChange} />
              <i className="search icon"></i>
            </div>
          </div>

          {poem.map((eachPoem) => <SideBarPoemItem key={eachPoem.id} setSelectPoem={setSelectPoem} eachPoem={eachPoem} />)}
